...
const PATH_CAPTURE_START = "__ASSIST_PATH_START__";
const PATH_CAPTURE_END = "__ASSIST_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__ASSIST_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__ASSIST_ENV_${name}_END__`;
}
