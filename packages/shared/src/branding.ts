export const BRAND_MARK_VIEW_BOX = "0 0 45 45";
export const BRAND_MARK_VIEW_BOX_SIZE = 45;
...
export const BRAND_MARK_DEFAULT_COLORS = [
...
export const BRAND_ICON_FOREGROUND_HEX = "#ffffff";
