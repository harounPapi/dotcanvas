...
export const WsCapabilitiesSearchRpc = Rpc.make(WS_METHODS.capabilitiesSearch, {
  payload: CapabilitySearchInput,
  success: CapabilitySearchResult,
  error: CapabilitySearchError,
});

export const WsCapabilitiesReadPluginBundleRpc = Rpc.make(WS_METHODS.capabilitiesReadPluginBundle, {
  payload: CapabilityReadPluginBundleInput,
  success: PluginBundleResult,
  error: CapabilityReadPluginBundleError,
});
