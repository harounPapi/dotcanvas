...
const SHARED_CLIENT_ICON_OVERRIDES: ReadonlyArray<IconOverride> = [
  {
...
export const DEVELOPMENT_ICON_OVERRIDES = SHARED_CLIENT_ICON_OVERRIDES;

export const PUBLISH_ICON_OVERRIDES = SHARED_CLIENT_ICON_OVERRIDES;
