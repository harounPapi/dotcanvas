        ...
        <div className="group/project-header relative">
          ...
          <Tooltip>
                ...
                <SidebarMenuAction
                  render={
                    <button
                      ...
                      disabled={isStartLockedProject}
                    />
                  }
                  showOnHover
                  className="top-1 right-1.5 size-5 rounded-md p-0 text-muted-foreground/70 hover:bg-secondary hover:text-foreground disabled:cursor-not-allowed disabled:opacity-50"
                  onClick={(event) => {
                    if (isStartLockedProject) {
                      return;
                    }
                    event.preventDefault();
                    event.stopPropagation();
            ...
            <TooltipPopup side="top">
              {isStartLockedProject
                ? "Finish setup to unlock new threads"
        ...
        <TooltipTrigger
          render={
            <Link
              ...
              className="ml-1 flex min-w-0 flex-1 cursor-pointer items-center justify-between gap-3 rounded-md outline-hidden ring-ring transition-colors hover:text-foreground focus-visible:ring-2"
              to="/"
            >
